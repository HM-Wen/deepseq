#!/data/galaxy/software/bin/pyhon2.7
...
def __main__():
    ...
    go_map_org=dict(Arabidopsis_thaliana="/data/oqtansTools/oqtans/topGO/data/ATH_GO_TAIR.txt",
		Drosophila_melanogaster="/data/oqtansTools/oqtans/topGO/data/DM_GO_FB.txt",
		Mus_musculus="/data/oqtansTools/oqtans/topGO/data/MM_GO_MGI.txt",
                Saccharomyces_cerevisiae="/data/oqtansTools/oqtans/topGO/data/SCV_GO_SGD.txt")
